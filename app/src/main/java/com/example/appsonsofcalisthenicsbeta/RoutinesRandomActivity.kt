...
class RoutinesRandomActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    private lateinit var drawer: DrawerLayout

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_routines_random)
    ...
    private fun initToolBar(){
        val toolbar: androidx.appcompat.widget.Toolbar = findViewById(R.id.toolbar_routines_random)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layoutRoutines_random)
    ...
    private fun initNavigationView(){
        var navigationView: NavigationView = findViewById(R.id.nav_viewRoutines_random)
